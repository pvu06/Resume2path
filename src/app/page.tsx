...
export default function HomePage() {
  ...
  const finalRole = isCustomRole ? (customRole || 'Other') : (formData.targetRole || '');
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    value={isCustomRole ? 'other' : (formData.targetRole || '')}
                    onChange={(e) => {
                    ...
                    {!file ? (
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-center gap-3">
                          <Button type="button" variant="outline" onClick={handleChooseFile} className="bg-white text-black border border-white hover:bg-transparent hover:text-white hover:border-white">
                            Re-upload
                          </Button>
                          <Button type="button" variant="destructive" onClick={handleRemoveFile} className="bg-red-600 hover:bg-red-700">
                            Remove
                          </Button>
                        </div>
                      </div>
